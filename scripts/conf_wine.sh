...
wine_setup() {
    ...
    WINEPREFIX="$WINE_PREF_PATH" winetricks --unattended atmlib fontsmooth=rgb gdiplus vcrun2005 vcrun2008 vcrun2010 vcrun2012 vcrun2013 vcrun2017 msxml3 msxml6 corefont 2>&1 | tee "$LOG_FILE"
    if [ $? -eq 0 ]; then
