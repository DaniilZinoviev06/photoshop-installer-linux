...
wine_setup() {
    ...
    sleep 5
    WINEPREFIX="$WINE_PREF_PATH" winetricks --unattended atmlib fontsmooth=rgb gdiplus vcrun2008 vcrun2010 vcrun2012 vcrun2013 msxml3 msxml6 gdiplus corefonts 2>&1 | tee "$LOG_FILE"
    sleep 5
